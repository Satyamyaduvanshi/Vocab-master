...
import { BookOpen, Zap, Infinity as InfinityIcon, Moon, Sun, Coffee, RotateCcw, User, Hash, ArrowRight, Flame, ChevronLeft, ChevronRight, Library, Home } from "lucide-react";
  ...
  return (
    <main className="min-h-screen flex justify-center items-center bg-gray-50 dark:bg-[#0a0a0a] text-neutral-900 dark:text-neutral-100 p-4 transition-colors duration-300">
      ...
      <div className="w-full max-w-5xl flex flex-col gap-4">
        ...
        {/* TOP NAVIGATION (New Back Button) */}
        <div className="w-full flex justify-start">
          <Link href="/" className="flex items-center gap-2 text-gray-500 hover:text-neutral-900 dark:text-neutral-400 dark:hover:text-white transition-all text-sm font-bold bg-white dark:bg-[#121212] px-4 py-2 rounded-xl border border-gray-200 dark:border-neutral-800 shadow-sm">
